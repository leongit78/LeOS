...
char_loop:
    ...
    add bx, 2   ; Пропускаaем первые два символа '0x'
...
print_hex_done:
    ...
    ; Теперь нужно привести HEX_OUT к изначальному состоянию 0x0000
    add bx, 2 ; Пропускаем 0x
    mov cx, 4 ; Нужно обнулить 4 символа

reset_hex_out_loop:
    mov byte [bx], '0'
    inc bx
    loop reset_hex_out_loop
